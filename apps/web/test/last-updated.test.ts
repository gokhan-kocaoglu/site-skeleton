...
describe("getLastUpdated", () => {
  it("formats a given UTC date into an ISO day string and an en-US long display string", () => {
    // Arrange
    ...
    expect(result.display).toBe("July 3, 2026");
  });
  ...
  it("zero-pads single-digit month and day in the iso string", () => {
    ...
    expect(result.display).toBe("January 5, 2026");
  });
